...
const Cart = () => {
  ...
  const checkout = () => {
    ...
    toast({
      ...
      description: `Total: R$ ${totalCartPrice.toFixed(
        2
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "Em um sistema real, você seria redirecionado para o gateway de pagamento.",
      });
    }, 2000);
  };
      ...
      >
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m5.5-5v6a1 1 0 01-1 1H9a1 1 0 01-1-1v-6m8 0V9a1 1 0 00-1-1h-4a1 1 0 00-1 1v4.01"
          />
        </svg>
        {totalCartItems > 0 && (
